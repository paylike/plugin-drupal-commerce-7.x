...
use Ubercart\UbercartTestHelper;

class DrupalCommerceTestHelper {
	...
	/**
	 * DrupalCommerceTestHelper constructor.
	 *
	 * @param \DrupalCommerce\DrupalCommerceTest\DrupalCommerce\DrupalCommerceFullTest $drupalcommerce_test
	 */
	public function __construct( $drupalcommerce_test ) {
		$this->main_test    = $drupalcommerce_test;
		$this->wd           = $drupalcommerce_test->wd;
	 ...
	 * @param bool $is_admin
	 *
	 * @return DrupalCommerceTestHelper
